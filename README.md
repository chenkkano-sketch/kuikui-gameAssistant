...
- 安装版：`KuikuiGameAssistant-1.0.6-setup.exe`
- 便携版：`KuikuiGameAssistant-1.0.6-win-x64-portable.zip`
...
```powershell
.\scripts\package.ps1 -Version 1.0.6 -SkipInstaller
```

输出文件：

- `artifacts\KuikuiGameAssistant-1.0.6-setup.exe`
- `artifacts\KuikuiGameAssistant-1.0.6-win-x64-portable.zip`
